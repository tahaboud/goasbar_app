        ...
        children: [
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              validator: label == "Minimum age".tr()
                  ? (value) {
                      if (isNumeric(value!)) {
                        return null;
                      } else {
              ...
              autovalidateMode: label == "Minimum age".tr()
                  ? AutovalidateMode.onUserInteraction
                  : AutovalidateMode.disabled,
              maxLength: label == "Identity number"
                  ? 10
                  : label == "Minimum age".tr()
                      ? 2
                      : null,
              keyboardType: label == "Identity number" ||
                      label == "IBAN" ||
              ...
              decoration: InputDecoration(
                ...
                filled: true,
                counterText:
                    label == "Identity number" || label == 'Minimum age'.tr()
                        ? ""
                        : null,
