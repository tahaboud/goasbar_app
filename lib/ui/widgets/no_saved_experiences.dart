...
class NoSavedExperiences extends StatelessWidget {
  const NoSavedExperiences({
    Key? key,
    required this.text,
    this.onTap,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text('No saved experiences', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w500),),
        verticalSpaceSmall,
