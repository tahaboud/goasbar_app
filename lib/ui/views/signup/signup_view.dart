        ...
        body: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              verticalSpaceSmall,
              const Text(
                "Find your best experience in Saudi Arabia with GoAsbar",
                style: TextStyle(color: kMainGray, fontSize: 13),
              ).center(),
              verticalSpaceTiny,
              TextFormField(
                maxLength: 9,
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: phone.text.isNotEmpty
                        ? kMainGradient
