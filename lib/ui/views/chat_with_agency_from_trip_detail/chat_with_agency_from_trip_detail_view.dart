...
class ChatWithAgencyFromTripDetailView extends HookWidget {
  const ChatWithAgencyFromTripDetailView(
      {super.key, this.meId, this.providerId, this.notMeName, this.notMeId});
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<ChatWithAgencyFromTripDetailViewModel>.reactive(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: Image.asset("assets/icons/import.png").gestures(
                        onTap: () => model.sendMessage(
                            notMeId: notMeId!.toString(),
                            message: message,
                            meId: meId!.toString())),
      ...
      viewModelBuilder: () => ChatWithAgencyFromTripDetailViewModel(
